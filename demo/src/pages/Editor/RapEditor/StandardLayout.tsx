...
import { InteractivePrompt, MergeTagBadgePrompt } from 'easy-email-extensions';
import styles from './index.module.scss';
import enUS from '@arco-design/web-react/es/locale/en-US';
import { AdvancedType } from 'easy-email-core';
import { ExtensionProps, ExtensionProvider } from './ExtensionProvider';

const EditPanel = React.lazy(() =>
  import('./EditPanel').then(mod => ({ default: mod.EditPanel }))
);
const ConfigurationPanel = React.lazy(() =>
  import('./ConfigurationPanel').then(mod => ({ default: mod.ConfigurationPanel }))
);
